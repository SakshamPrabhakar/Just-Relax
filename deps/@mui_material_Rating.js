...
var Star_default = createSvgIcon((0, import_jsx_runtime5.jsx)("path", {
...
var StarBorder_default = createSvgIcon((0, import_jsx_runtime6.jsx)("path", {
...
function IconContainer(props) {
  ...
  return (0, import_jsx_runtime7.jsx)("span", _extends({}, other));
}
...
function RatingItem(props) {
  ...
  const container = (0, import_jsx_runtime7.jsx)(RatingIcon, {
  ...
  if (readOnly) {
    return (0, import_jsx_runtime7.jsx)("span", _extends({}, labelProps, {
      children: container
    }));
  }
  return (0, import_jsx_runtime8.jsxs)(React6.Fragment, {
    children: [(0, import_jsx_runtime8.jsxs)(RatingLabel, _extends({
      ownerState: _extends({}, ownerState, {
        emptyValueFocused: void 0
      }),
      htmlFor: id
    }, labelProps, {
      children: [container, (0, import_jsx_runtime7.jsx)("span", {
...
var defaultIcon = (0, import_jsx_runtime7.jsx)(Star_default, {
  fontSize: "inherit"
});
var defaultEmptyIcon = (0, import_jsx_runtime7.jsx)(StarBorder_default, {
  fontSize: "inherit"
});
...
var Rating = React6.forwardRef(function Rating2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(RatingRoot, _extends({
    ref: handleRef,
    ...
    children: [Array.from(new Array(max)).map((_, index) => {
      ...
      if (precision < 1) {
        ...
        return (0, import_jsx_runtime7.jsx)(RatingDecimal, {
          className: clsx_default(classes.decimal, isActive && classes.iconActive),
          ownerState,
          iconActive: isActive,
          children: items.map(($, indexDecimal) => {
            const itemDecimalValue = roundValueToPrecision(itemValue - 1 + (indexDecimal + 1) * precision, precision);
            return (0, import_jsx_runtime7.jsx)(RatingItem, _extends({}, ratingItemProps, {
    ...
    }), !readOnly && !disabled && (0, import_jsx_runtime8.jsxs)(RatingLabel, {
