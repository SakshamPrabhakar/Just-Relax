...
function QuesFriend() {
    ...
    const model = genAI.getGenerativeModel({
        ...
        systemInstruction: "You are a mental health analyser tool on a mental health platform 'JustRelax'. You will recieve questions and the answers which the user has given and you have to provide an analysis to the user of their answers in a short and concise manner in not more than 250 words. Don't provide any help based resources. Refrain from using strong words like depression. Do not mention that you are an AI."
    });
    ...
    const handleTalkToBuddy = () => {
        console.log("Talk to Buddy clicked");
    };
